...
class PlanController extends GetxController {
  ...
  onBodyFocusItemClick(HomePlanTable bodyFocusItem) {
    Get.toNamed(AppRoutes.homeDetail, arguments: [bodyFocusItem])!
        .then((value) => refreshData());
    print(bodyFocusItem.planName);
  }
  ...
  onRecentItemClick() async {
    ...
    } else if (recentHistoryList[0].planDetail!.planDays ==
        Constant.planDaysYes) {
