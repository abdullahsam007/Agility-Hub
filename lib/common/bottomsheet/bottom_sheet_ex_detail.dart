                    ...
                    AnimatedBuilder(
                      ...
                      builder: (BuildContext context, Widget? child) {
                        String frame = widget
                            ...
                            .toString();
                        return Image.asset(
                          'assets/${widget.exerciseList![mainPageIndex].exPath}/$frame.webp',
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  GetBuilder<ExerciseListController>(
                      id: Constant.idEditTimeInPlan,
                      builder: (logic) {
                        return Container(
                          margin:
                              EdgeInsets.symmetric(vertical: AppSizes.height_2),
                          child: Row(
                            children: [
                              Expanded(
                                child: Text(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    logic.isShowResetWidget(
                                        widget.exerciseList![mainPageIndex]
                                            .exTime!,
                                        duration[mainPageIndex]);
                              ...
                              Container(
                                ...
                                child: Text(
                                  (widget.exerciseList![mainPageIndex].exUnit ==
                                          Constant.workoutTypeStep)
                                      ? duration[mainPageIndex].toString()
                                      : Utils.secToString(
                                          duration[mainPageIndex]),
                                  textAlign: TextAlign.start,
                                  style: TextStyle(
