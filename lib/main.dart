...
Future<void> main() async {
  ...
  await flutterLocalNotificationsPlugin.initialize(initializationSettings,
    ...
    } else if (payload != null && payload == Constant.strWaterReminder) {}
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      initialRoute:
          (Utils.isFirstTimeOpenApp()) ?
          AppRoutes.initial : AppRoutes.home,
    );
  }
}

class CustomAdShowing extends StatefulWidget {
  const CustomAdShowing({Key? key}) : super(key: key);

  @override
  State<CustomAdShowing> createState() => _CustomAdShowingState();
}

class _CustomAdShowingState extends State<CustomAdShowing> {
  @override
  void initState() {
